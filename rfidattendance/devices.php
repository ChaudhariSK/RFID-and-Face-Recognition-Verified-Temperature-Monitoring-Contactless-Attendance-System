...
<main>
	...
	<section class="container py-lg-5">
		...
		<div class="row">
			...
			<h1 class="slideInDown animated">Sanitization Device</h1>
				<button type="button" class="btn btn-success" data-toggle="modal" data-target="#new-device" style="font-size: 18px; float: ; margin-top: -6px; margin-left: 500px;"><a href="http://192.168.43.153/" style="color:white;">Sanitization</a></button>
		</div>
		<!-- \\devices -->
		<!-- New Devices -->
